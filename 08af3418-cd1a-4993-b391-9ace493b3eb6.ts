export default {
  ...
  "parser_option": {
    ...
    "articles": [
      ...
      {
        "title": "沿着十月社会主义革命开辟的道路前进——纪念伟大的十月社会主义革命五十周年",
        "authors": [
          "《人民日报》编辑部",
          "《红旗》杂志编辑部",
          "《解放军报》编辑部"
      ...
      {
        "title": "大树特树伟大统帅毛主席的绝对权威，大树特树伟大的毛泽东思想的绝对权威——彻底清算罗瑞卿反对毛主席、反对毛泽东思想的滔天罪行",
        "authors": [
          "杨成武"
        ],
        "page_start": 31,
      ...
      {
        "title": "斗私批修的一种好形式——北京部队某连开展“一帮一、一对红”活动的情况调查",
        "authors": [
          "《红旗》杂志调查员"
        ],
        "page_start": 43,
  ...
  "path": "08af3418-cd1a-4993-b391-9ace493b3eb6.pdf",
  "resource_type": "book",
  "version": 2
}